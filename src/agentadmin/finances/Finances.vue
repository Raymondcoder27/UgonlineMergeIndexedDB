...
// import BackofficeAccounts from "@/agentadmin/accounts/BackofficeAccounts.vue";
// import UserAccounts from "@/agentadmin/accounts/UserAccounts.vue";
...
import FloatAllocationTabbed from "@/agentadmin/finances/FloatAllocationTabbed.vue";
    ...
    <div class="flex">
      ...
      <div class="flex">
        ...
        <!-- <i class="fas fa-wallet px-1 pt-0.5 text-red-700"></i> -->
          ...
          <span class="px-1">Final Float: {{ finalFloat.currentFinalFloat.toLocaleString() }}/=</span>
          </span>
      </div>
    </div>
    <div class="flex pt-5">
