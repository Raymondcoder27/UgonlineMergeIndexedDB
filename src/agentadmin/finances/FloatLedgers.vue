...
import { useBilling } from "@/agentadmin/finances/stores"; // Import the appropriate store
...
import { useBalance } from "@/agentadmin/balance/stores"; // Import the balance store
