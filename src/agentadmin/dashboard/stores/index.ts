...
import {type GatewayResponseInterface} from "@/agentadmin/gateway/types";
import api from "@/config/api";
import type {ProviderRegistrationStatistic, Statistic} from "@/agentadmin/analytics/types/chart";
