...
import GatewayStatistics from "@/agentadmin/analytics/views/GatewayStatistics.vue";
import {type Ref, ref} from "vue";
import ProviderStatistics from "@/agentadmin/analytics/views/ProviderStatistics.vue";
import ServicesStatistics from "@/agentadmin/analytics/views/ServicesStatistics.vue";
import RevenueStatistics from "@/agentadmin/analytics/views/RevenueStatistics.vue";
import UserStatistics from "@/agentadmin/analytics/views/UserStatistics.vue";
