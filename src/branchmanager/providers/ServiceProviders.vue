...
import CreateServiceProvider from "@/branch-manager/providers/views/CreateServiceProvider.vue";
import moment from "moment";
import coa from "@/assets/images/coa_gs.png"
import EditServiceProvider from "@/branch-manager/providers/views/EditServiceProvider.vue";
import type {ServiceProvider} from "@/branch-manager/providers/types";
  ...
  <div class="w-full shadow-lg bg-white rounded p-2">
    <div class="flex">
      <div class="w-full py-1">
        <i class="bg-primary-700 border border-primary-800 text-white p-2 rounded-full fa-solid fa-house"></i>
        <label class="text-lg mx-1">Service Providers</label>
      </div>
    </div>
    <div class="flex space-x-2 my-1">
      <div class="flex-grow">
        <div class="flex bg-gray-10 border border-gray-200 rounded px-2 py-3">
          <input class="filter-element e-input w-4/12" type="text" placeholder="Search by Name" />
        ...
        <div class="flex">
          <div class="w-full">
            <div class="flex" v-if="limit == store.providers?.length || page > 1">
              ...
              <button v-if="limit == store.providers?.length" class="pagination-button" @click="next">Next <i class="fa-solid fa-arrow-right"></i></button>
