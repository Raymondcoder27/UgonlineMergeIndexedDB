...
function submit(userId: string) {
  ...
  notify.success(`User successfully assigned to Till ${payload.tillId}`);
...
@/branchmanagerdomain/tills/stores@/branchmanager/tills/stores@/branchmanager/accounts/stores