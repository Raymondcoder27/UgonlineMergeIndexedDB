          ...
          >
            ...
            <td class="text-right">
              ...
              <div v-if="request.status === 'approved'">
                ...
                <!-- <label> -->
                <span
                  class="text-xs cursor-pointer rounded-md px-1 py-0.5 font-semibold text-white bg-blue-600 hover:text-white hover:bg-blue-200 hover:text-blue-700"
                >
              ...
              <div v-else-if="request.status === 'rejected'">
                ...
                <label>
                  <span
                    class="text-xs cursor-pointer rounded-md px-1 py-0.5 font-semibold text-white bg-blue-600 hover:bg-blue-200 hover:text-blue-700"
                    @click="view(request)"
                  >
                    <!-- <i class="fa-solid fa-times-square"></i>
                  Rejected</span
