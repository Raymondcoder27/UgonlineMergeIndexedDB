...
import { FloatRequest } from "@/branch-manager/finances/types";
...
<!-- @/agentdomain/ledger/types -->
 <!-- @/branchmanager/finances/stores@/branchmanager/balance/stores@/branchmanager/finances/types -->@/branch-manager/finances/stores/index2@/branch-manager/finances/stores/index2@/branch-manager/finances/stores/index copy