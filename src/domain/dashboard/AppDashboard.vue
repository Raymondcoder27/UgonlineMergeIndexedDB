  ...
  <div class="grid grid-cols-8 py-1">
    <div class="w-full">
      <div class="w-12/12 count">
        ...
        <p class="text-xl font-bold py-2" style="font-size: 18px;">{{ totalServiceSubscriptions }}</p>
    ...
    <div class="w-full">
      <div class="w-12/12 count">
        ...
        <p class="text-xl font-bold py-2" style="font-size: 18px;">{{ totalBranchManagers }}</p>
    ...
    <div class="w-full">
      <div class="w-12/12 count">
        ...
        <p class="text-xl font-bold py-2" style="font-size: 18px;">{{ totalBackOfficeAccounts }}</p>
    ...
    <div class="w-full">
      <div class="w-12/12 count">
        <p class="text-xl font-bold py-2" style="font-size: 18px;">17</p>
    ...
    <div class="w-full">
      <div class="w-12/12 count">
        ...
        <p class="text-xl font-bold py-2" style="font-size: 18px;">{{ pendingFloatRequests }}</p>
    ...
    <div class="w-full">
      <div class="w-12/12 count">
        ...
        <p class="text-xl font-bold py-2" style="font-size: 18px;">{{ totalTransactions }}</p>
    ...
    <div class="w-full">
      <div class="w-12/12 count">
        ...
        <p class="text-xl font-bold py-2" style="font-size: 18px;">{{ totalBalance.current.toLocaleString() }}/=</p>
