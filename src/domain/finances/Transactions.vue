...
import TransactionDetails from "@/domain/finances/components/TransactionDetails.vue";
      ...
      <table class="table tr">
        ...
        <tbody>
          ...
          >
            ...
            <td class="rounded-md font-semibold text-red-700">{{ transaction.transactionID }}</td>
