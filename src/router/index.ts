...
const mergedRoutes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    // redirect: "/tilloperator/services",
...
// branch-manager-app-accounts
  ...
  },
  {
    ...
    // redirect: "/tilloperator/services",
    redirect: "/tilloperator/api-services",
    children: [
      { name: "agent-app-services", path: "/tilloperator/services", component: AgentAppServices },
      { name: "agent-app-entities", path: "/tilloperator/entities", component: AgentAppEntities },
      { name: "agent-app-agents", path: "/tilloperator/agents", component: AgentAppAgents },
      // { name: "agent-app-branches", path: "/tilloperator/branches", component: AgentBranches },
      { name: "agent-app-configurations", path: "/tilloperator/configurations", component: AgentSettings },
      { name: "agent-app-ledger", path: "/tilloperator/ledger", component: AgentLedger },
      { name: "agent-app-services-details", path: "/tilloperator/services-details", component: AgentServicesDetails },
      { name: "agent-app-finances", path: "/tilloperator/finances", component: AgentAppFinances },
      { name: "agent-app-gateway", path: "/tilloperator/gateway", component: AgentAppGateway },
      { name: "agent-app-submissions", path: "/tilloperator/submissions", component: AgentSubmissions },
      { name: "agent-api-app-submissions", path: "/tilloperator/api-submissions", component: ApiSubmissions },
      { name: "api-services", path: "/tilloperator/api-services", component: ApiServices },
...
router.beforeEach((to, from, next) => {
  ...
  if (to.meta.title) {
    ...
    document.title = "UGOnline Admin Portal"; // Fallback title
  }
